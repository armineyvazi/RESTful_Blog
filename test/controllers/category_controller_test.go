...
func Test_category_controller_Get_All(t *testing.T) {
	...
	//mockCategoryRepository := repositories.MockCategoryRepository{}
	controller := &controllers.CategoryController{
		CategoryService: mockCategoryService,
	}
...
func Test_put_category(t *testing.T) {
	...
	mockService.UpdateCategoryFunc = func(category *models.Category) error {
		return nil
	}
...
func TestPostCategory(t *testing.T) {
	...
	mockService.CreateCategoryFunc = func(category *models.Category) error {
